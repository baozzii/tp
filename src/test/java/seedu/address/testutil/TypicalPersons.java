...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withTags("friends").withPriority(1).withEmergencyContact((EmergencyContact) null).build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25").withEmail("johnd@example.com")
            .withPhone("98765432").withOrgan("kidney").withBloodType("O-")
            .withTags("owesMoney", "friends").withPriority(2).withEmergencyContact((EmergencyContact) null).build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street").withOrgan("cornea")
            .withBloodType("A-").withPriority(3).withEmergencyContact((EmergencyContact) null).build();
