...
public class CommandTestUtil {
    ...
    public static final String VALID_EMERGENCY_NAME_AMY = "Amy Emergency";
    public static final String VALID_EMERGENCY_NAME_BOB = "Bob Emergency";
    ...
    public static final String VALID_EMERGENCY_RELATION_AMY = "spouse";
    public static final String VALID_EMERGENCY_RELATION_BOB = "parent";
    public static final String VALID_ADDRESS_AMY = "Block 312, Amy Street 1";
    public static final String VALID_ADDRESS_BOB = "Block 123, Bobby Street 3";
    public static final String VALID_ORGAN_AMY = "liver";
    public static final String VALID_ORGAN_BOB = "kidney";
    public static final String VALID_TAG_HUSBAND = "husband";
    public static final String VALID_TAG_FRIEND = "friend";
    public static final Integer VALID_PRIORITY_AMY = 1;
    public static final Integer VALID_PRIORITY_BOB = 3;
    ...
    public static final String EMERGENCY_NAME_DESC_AMY = " " + PREFIX_EMERGENCY_NAME + VALID_EMERGENCY_NAME_AMY;
    public static final String EMERGENCY_NAME_DESC_BOB = " " + PREFIX_EMERGENCY_NAME + VALID_EMERGENCY_NAME_BOB;
    ...
    public static final String EMERGENCY_RELATION_DESC_AMY = " " + PREFIX_EMERGENCY_RELATION
            + VALID_EMERGENCY_RELATION_AMY;
    public static final String EMERGENCY_RELATION_DESC_BOB = " " + PREFIX_EMERGENCY_RELATION
            + VALID_EMERGENCY_RELATION_BOB;
    public static final String ADDRESS_DESC_AMY = " " + PREFIX_ADDRESS + VALID_ADDRESS_AMY;
    public static final String ADDRESS_DESC_BOB = " " + PREFIX_ADDRESS + VALID_ADDRESS_BOB;
    public static final String ORGAN_DESC_AMY = " " + PREFIX_ORGAN + VALID_ORGAN_AMY;
    public static final String ORGAN_DESC_BOB = " " + PREFIX_ORGAN + VALID_ORGAN_BOB;
    ...
    public static final String INVALID_EMERGENCY_NAME_DESC = " "
            + PREFIX_EMERGENCY_NAME + "John&"; // '&' not allowed in names
    public static final String INVALID_EMERGENCY_PHONE_DESC = " "
            + PREFIX_EMERGENCY_PHONE + "911a"; // 'a' not allowed in phones
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withOrgan(VALID_ORGAN_AMY).withBloodType(VALID_BLOODTYPE_AMY).withPriority(VALID_PRIORITY_LOW)
